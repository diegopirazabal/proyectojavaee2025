 ...
 * @version 1.0
 */
public class sincronizacion_confirmacion_message implements Serializable {
     ...
     */
    public sincronizacion_confirmacion_message() {
     ...
     */
    public sincronizacion_confirmacion_message(UUID documentoId, UUID historiaId, UUID tenantId, String cedula) {
     ...
     */
    public sincronizacion_confirmacion_message(UUID documentoId, UUID tenantId, String cedula, String errorMensaje) {
        this.documentoId = documentoId;
     ...
     */
    public static sincronizacion_confirmacion_message exitoso(UUID documentoId, UUID historiaId, UUID tenantId, String cedula) {
        return new sincronizacion_confirmacion_message(documentoId, historiaId, tenantId, cedula);
    }

    /**
     * Crea mensaje de confirmación con error
     */
    public static sincronizacion_confirmacion_message fallido(UUID documentoId, UUID tenantId, String cedula, String errorMensaje) {
        return new sincronizacion_confirmacion_message(documentoId, tenantId, cedula, errorMensaje);
    }
    ...
    public String toString() {
        return "sincronizacion_confirmacion_message{" +
