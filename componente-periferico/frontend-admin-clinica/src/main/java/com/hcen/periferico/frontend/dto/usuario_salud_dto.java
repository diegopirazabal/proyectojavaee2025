...
public class usuario_salud_dto implements Serializable {
    ...
    private String tipoDocumento;  // Nuevo campo (String para simplificar en frontend)
    ...
    public usuario_salud_dto(String cedula, String tipoDocumento, String primerNombre,
