...
public class UsuarioSalud {
    ...
    public UUID getTenantId() { return tenantId != null ? UUID.fromString(tenantId) : null; }
    public void setTenantId(UUID tenantId) { this.tenantId = tenantId != null ? tenantId.toString() : null; }
